        ...
        <div className="flex bg-slate-200 dark:bg-slate-800 p-3 rounded-lg items-center px-5 select-none">
            ...
            <nav className="flex w-full">
                ...
                <ul className="flex items-center ml-auto">
                    <li>
                        {props.darkMode ? (
                            <BsSunFill onClick={() => { props.setDarkMode(false) }} className="cursor-pointer text-xl" />
                        ) : (
                            <BsFillMoonStarsFill onClick={() => { props.setDarkMode(true) }} className="cursor-pointer text-xl" />
                        )}
                    </li>
                </ul>
            </nav>
