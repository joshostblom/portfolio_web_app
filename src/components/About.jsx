      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p>
            ...
            December 2024 with highest distinction and I'm finishing a master's
            degree in computer science by December 2025 through an accelerated
            program. I have achieved a spot on the Dean's list for every
            semester completed so far.
          </p>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-5">
            <p>
              ...
              Outside of programming, I enjoy tennis, hanging out with friends,
              and take pictures of the night sky. You can find my photos on my
              ...
              saxophone. In high school, I was part of a quartet that performed
              the national anthem at a Storm Chasers baseball game. This
              semester, I’ll be getting back into music by participating in
              the&nbsp;
              <a
